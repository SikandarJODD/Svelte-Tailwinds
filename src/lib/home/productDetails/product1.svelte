<script>
  ...
  let pdata = {
    ...
    productName: "Pullover with pattern",
    rating: 4.2,
    ratingCount: 56,
    price: 450,
    priceOld: 600,
    shippingNotice: "2-4 day shipping",
    sizes: ["XS", "S", "M", "L", "XL"],
    imgs: [
      "https://images.unsplash.com/flagged/photo-1571366992791-2ad2078656cb?auto=format&q=75&fit=crop&w=600",
      "https://images.unsplash.com/flagged/photo-1571366992968-15b65708ee76?auto=format&q=75&fit=crop&w=600",
      "https://images.unsplash.com/flagged/photo-1571366992999-47669b775ef6?auto=format&q=75&fit=crop&w=600",
    ...
    <div class="grid gap-8 md:grid-cols-2">
      ...
      <div class="grid gap-4 lg:grid-cols-5">
        <div class="order-last flex gap-4 lg:order-none lg:flex-col">
          {#each pdata.imgs as item, i}
            ...
            <div
              class=" p-1 overflow-hidden rounded-lg bg-gray-100 {i ===
              select_img
      ...
      <div class="md:py-8">
        ...
        <div class="mb-6 flex items-center gap-3 md:mb-10">
          <div
            class="flex h-7 items-center gap-1 rounded-full bg-indigo-500 px-2 text-white"
          >
        ...
        <div class="mb-6 flex items-center gap-2 text-gray-500">
          ...
          <span class="text-sm">{pdata.shippingNotice}</span>
        </div>
        <!-- shipping notice - end -->
