      ...
      <div class="grid gap-8 md:grid-cols-2">
        ...
        <div class="grid gap-4 lg:grid-cols-5">
          <div class="order-last flex gap-4 lg:order-none lg:flex-col">
            ...
            <div class="overflow-hidden rounded-lg bg-gray-100">
              <img src="https://images.unsplash.com/flagged/photo-1571366992999-47669b775ef6?auto=format&q=75&fit=crop&w=250" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
            </div>
          </div>
